...
public class Service {
    ...
    public void deleteFriendship(Long id) {this.friendshipRepository.delete(id);}
    ...
    public List<User> getFriends(User user){return this.userRepository.getFriends(user);}
